...
# The official documentation forgot to mention pear but we will include it
sudo dnf install -y php-{gd,mysql,mbstring,bcmath,xml,curl,zip,intl,sqlite3,fpm,pear}
